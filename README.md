# code-server-operator on Kubernetes
Kubernetes Operator implementation for [code-server](https://github.com/coder/code-server).  
Run code-server on Kubernetes.  

This is developed with [kubebuilder](https://book.kubebuilder.io/) framework version 4.  

The project is WIP and not tested for production use. 
